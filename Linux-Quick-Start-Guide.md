...
```
cmake <path-to-source> -DNETWORK_INTEGRATION_TESTS=ON –DNETWORK_INETRFACE=eth0
```
...
* [Runtime Configuration for CA Certificates](https://github.com/alexa/alexa-client-sdk/wiki/Runtime-Configuration-for-CA-Certificates)  
